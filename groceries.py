...
#FROM CLASS
#import operator
#TODO: from sorted products variable get list of unique departments
#if departmentname not in department
products = [
    {"id":1, "name": "Chocolate Sandwich Cookies", "department": "snacks", "aisle": "cookies cakes", "price": 3.50},
    {"id":2, "name": "All-Seasons Salt", "department": "pantry", "aisle": "spices seasonings", "price": 4.99},
    {"id":3, "name": "Robust Golden Unsweetened Oolong Tea", "department": "beverages", "aisle": "tea", "price": 2.49},
...
#matching_products = [x for x in products if x["department"] == departments]

example = "snacks"
matching_products = len([x["name"] for x in products if x["department"] == example])
